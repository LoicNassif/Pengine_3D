...
// Default Constructor
Contact::Contact() : pos(), n(), t1(), t2(), pene(0.0f), mu(0.4f), body0(nullptr), body1(nullptr), k(1e6f), b(1e5f) {}

Contact::Contact(Object* _body0, Object* _body1, const Eigen::Vector3f& _pos, const Eigen::Vector3f& _n, float _pene) 
    : pos(_pos), n(_n), t1(), t2(), mu(0.4f), pene(_pene), body0(_body0), body1(_body1), k(1e6f), b(1e5f)
{
    J0.setZero(3, 6);
    J1.setZero(3, 6);
}
